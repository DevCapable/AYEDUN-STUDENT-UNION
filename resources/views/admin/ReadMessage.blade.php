            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <ul class="nav nav-pills flex-column">
                  ...
                  <li class="nav-item">
                    <a href="{{ url('administrator/updateReadMessage/'. $Message->id ) }}" class="nav-link">
                      <i class="fa fa-check"></i> Mark as read
                      <span class="badge bg-warning float-right">{{ $unreadMessage }}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
              ...
              <div class="mailbox-controls with-border text-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm" data-container="body" title="Delete">
                   <a href="{{ url('administrator/deletemessage/'. $Message->id) }}"> <i class="far fa-trash-alt"></i></a>
                  </button>
            ...
            <div class="card-footer">
              ...
              <a href="{{ url('administrator/deletemessage/'. $Message->id) }}"><button type="button" class="btn btn-default"><i class="far fa-trash-alt"></i> Delete</button></a>
