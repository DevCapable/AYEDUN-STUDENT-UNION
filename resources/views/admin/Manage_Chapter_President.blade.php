...
<body style="padding-top: 1px">
   ...
   <!-- NAVBAR ENDS HERE--->
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Chapter President</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Table below shows all the Available Chapter President</h3>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    <tr>
                                        <td colspan="12" id="header">
                                            <h2>All Chapter President Since 1980-Now <i
                                                    class=" fa fa-clock"></i>({{ now() }})<h2>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th width="135px">@sortablelink('chapter')</th>
                                        <th width="135px">@sortablelink('History')</th>
                                        <th width="135px">@sortablelink('DP')</th>
                                        <th width="800px">ACTION</th>
                                    </tr>
                                    @foreach ($ChapterPresidents as $Chapter)
                                        <tr>
                                            <td width="80px">{{ $Chapter->full_name }}</td>
                                            <td width="135px">{{ $Chapter->compound }}</td>
                                            <td width="80px">{{ $Chapter->gender }}</td>
                                            <td width="100px">{{ $Chapter->discepline }}</td>
                                            <td width="80px">{{ $Chapter->institution }}</td>
                                            <td width="100px">{{ $Chapter->date_of_birth }}</td>
                                            <td width="100px">{{ $Chapter->year_of_tenure_from }}</td>
                                            <td width="100px">{{ $Chapter->year_of_tenure_to }}</td>
                                            <td width="100px">{{ $Chapter->chapter }}</td>
                                            <td width="100px">{{ $Chapter->history }}</td>
                                            <td width="900px"><img src="{{ asset($Chapter->picture) }}"
                                                    class="img-thumbnail" width="900px" width="900px"
                                                    style="box-shadow: 0px 2px 7px 2px gray ;"
                                                    alt="Ayedun Students' Union" style="border-radius: 100px" /></td>
                                            <td width="340px">


                                                <a onclick="return confirm('Are you sure you want to delete {{ $Chapter->full_name }}?')"
                                                    href="{{ url('administrator/Delete_Chapter_President', $Chapter->id) }}"
                                                    title="Delete Chapter President">
                                                    <i class="fas fa-trash text-danger  fa-lg"></i></a>

                                                <a class="icon-credit-card" title="Click to Like"
                                                    href="{{ url('administrator/Edit_Chapter_President/' . $Chapter->id) }}"
                                                    title="Edit Chapter President"> <button id="edit-btn"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> <strong>ADD NEW ELECTED CHAPTER PRESIDENT<strong></h4>
                            </div>
                            <div class="card card-body bg-transparent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                ...
                                                @if ($errors->has('full_name'))
                                                    <span
                                                        class="font-weight-bold">{{ $errors->first('full_name') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div
                                                class="form-group {{ $errors->has('compound') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="compound" id="compound" class="form-control"
                                                    ...
                                                    @foreach ($getCompound as $compound)
                                                        ...
                                                        <option value=" {{ $compound->Name_of_Compound }}">
                                                            {{ $compound->Name_of_Compound }}</option>
                                            ...
                                            <div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="gender" id="gender" class="form-control"
                                                    ...
                                                    @if ($errors->has('gender'))
                                                        <span
                                                            class="font-weight-bold">{{ $errors->first('gender') }}</span>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div
                                                ...
                                                <select type="text" name="institution" id="institution"
                                                    ...
                                                    @foreach ($listOfSchools as $listOfSchool)
                                                        ...
                                                        <option value=" {{ $listOfSchool->ListSchools }}">
                                                            {{ $listOfSchool->ListSchools }}</option>
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_from" id="year_of_tenure_from"
                                                    class="form-control" value="{{ old('year_of_tenure_from') }}">
                                                @if ($errors->has('year_of_tenure_from'))
                                                    <span
                                                        class="font-weight-bold">{{ $errors->first('year_of_tenure_from') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_to" id="year_of_tenure_to"
                                                    class="form-control" value="{{ old('year_of_tenure_to') }}">
                                                @if ($errors->has('year_of_tenure_to'))
                                                    <span
                                                        class="font-weight-bold">{{ $errors->first('year_of_tenure_to') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group {{ $errors->has('history') ? 'has-error' : '' }}">
                                                <div>
                                                    <textarea id="text"  rows="4" name="history"
                                                        placeholder="Short history..." style="width: 100%"></textarea>
                                                </div>
                                                @if ($errors->has('history'))
                                                    <span
                                                        class="font-weight-bold">{{ $errors->first('history') }}</span>
                                                @endif
                                            </div>
                                        </div>
    ...
    <script>
        ...
        Toast.fire({
            icon: 'success',
            title: 'Administrator! Here You Can Manage Chapter President'
        })
