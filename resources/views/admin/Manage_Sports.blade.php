                        ...
                        <div class="card">
                            ...
                            <div class="card-body"style="overflow-x:auto;">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    @foreach ($sportDetails as $sportDetail)
                                        <tr>
                                            <td width="80px">{{ $sportDetail->full_name }}</td>
                                            <td width="135px">{{ $sportDetail->compound }}</td>
                                            <td width="80px">{{ $sportDetail->gender }}</td>
                                            <td width="100px">{{ $sportDetail->discepline }}</td>
                                            <td width="80px"> {{ $sportDetail->institution }}</td>
                                            <td width="100px">{{ $sportDetail->date_of_birth }}</td>
                                            <td width="100px">{{ $sportDetail->year_of_tenure_from }}</td>
                                            <td width="100px">{{ $sportDetail->year_of_tenure_to }}</td>
                                            <td width="100px">{{ $sportDetail->sport }}</td>
                                            <td width="100px">{{ $sportDetail->history }}</td>
                                            <td width="700px"><img src="{{ asset($sportDetail->picture) }}" class="img-thumbnail"
                                                width="500px" width="500px" style="box-shadow: 0px 2px 7px 2px gray ;"
                                                alt="Ayedun Students' Union" style="border-radius: 100px"/></td>
                                            <td width="340px">
                                                <a onclick="return confirm('Are you sure you want to delete {{ $sportDetail->full_name }}?')"
                                                    href="{{ url('administrator/Delete_Sports', $sportDetail->id) }}"
                                                    title="Delete sport Director">
                                                    <i class="fas fa-trash text-danger  fa-lg"></i></a>

                                                <a title="Click to Like"
                                                    href="{{ url('administrator/Edit_Sports/' . $sportDetail->id) }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('sport') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="sport" id="sport" class="form-control"
                                                    ...
                                                    @if ($errors->has('sport'))
                                                        <span
                                                            class="font-weight-bold">{{ $errors->first('sport') }}</span>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
