 ...
 <!-- NAVBAR ENDS HERE--->
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sent Mails / Warnings</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
           <a href="{{ route('send-mail') }}" class="btn btn-primary btn-block mb-3">Compose</a>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    @foreach($AdminSentMaill as $AdminInbox)
                  <tr>
                    <td>
                    ...
                    <td class="mailbox-name"><a href="{{ ('/administrator/readSentMail/'. $AdminInbox->id ) }}">{{ $AdminInbox->from_who }}</a></td>
                    <td class="mailbox-subject"><b> <a href="{{ ('/administrator/readSentMail/'. $AdminInbox->id ) }}"> {{ $AdminInbox->type_of_issue }}</a></b>
            ...
            <div class="card-footer p-0">
              <div class="mailbox-controls">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default btn-sm">
                   <a href="{{ url('administrator/deleteAllSentMail') }}"> <i class="far fa-trash-alt"> Delete All</i></a>
                  </button>
                  <button type="button" class="btn btn-default btn-sm">
                    <i class="fas fa-reply"></i>
                  </button>
