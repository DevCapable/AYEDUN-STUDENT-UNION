...
<body style="padding-top: 1px">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="{{ route('send-mail') }}" class="btn btn-primary btn-block mb-3"> <i class="far fa-envelope"></i> Send Single Mail  <i class="fa fa-arrow-alt-circle-right" ></i></a>
          <div class="card">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a href="{{ url('administrator/sentMail')}}" class="nav-link">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Send All Users Mail here</h3>
            ...
            <form method="POST"  novalidate>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <button type="submit" class="btn btn-outline-primary btn-lg btn-block"> Send Mail to All Users</button>
                </div>
              </div>
            </form>
