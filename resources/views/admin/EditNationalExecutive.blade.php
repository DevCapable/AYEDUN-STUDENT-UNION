...
<body style="padding-top: 1px">
 ...
 <!-- NAVBAR ENDS HERE--->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>UPDATE NATIONAL EXECUTIVES</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group" style="margin-bottom: 20px;">
                                    <img src="{{ asset($NationalExecutives->picture) }}" class="img-thumbnail"
                            ...
                            <div class="card card-body bg-transparent">
                                ...
                                <form method="POST" action="{{ url('administrator/ChangeExecutiveDp') }}"
                                  ...
                                  <div class="col-md-12" style="display:none">
                                    <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="id" id="id" class="form-control"
                                            value="{{ $NationalExecutives->id }}" readonly>
                                        @if ($errors->has('id'))
                                ...
                                <form method="POST" novalidate
                                    action="{{ url('administrator/UpdateNationalExecutive')}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('full_name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="full_name" id="full_name" class="form-control"
                                                    value="{{ $NationalExecutives->full_name }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('compound') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="compound" id="compound" class="form-control"
                                                    value="{{ $NationalExecutives->compound }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('discepline') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="discepline" id="discepline"
                                                    class="form-control" value="{{ $NationalExecutives->discepline }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="text" name="institution" id="institution"
                                                    class="form-control" value="{{ $NationalExecutives->institution }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="date_of_birth" class="form-control"
                                                    id="date_of_birth" value="{{$NationalExecutives->date_of_birth}}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_from" id="year_of_tenure_from"
                                                    class="form-control"
                                                    value="{{ $NationalExecutives->year_of_tenure_from }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_to" id="year_of_tenure_to"
                                                    class="form-control"
                                                    value="{{ $NationalExecutives->year_of_tenure_to }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="gender" id="gender" class="form-control"
                                                    value="{{ old('gender') }}">
                                                    <option value="{{$NationalExecutives->gender}}">...Select...
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                                ...
                                                <input type="number" name="phone" id="phone" class="form-control"
                                                    value="{{ $NationalExecutives->phone }}">
                                                @if ($errors->has('phone'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('chapter') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="chapter" id="chapter" class="form-control"
                                                    value="{{ old('chapter') }}">
                                                    <option value="{{ $NationalExecutives->chapter }}">...Select...
                                                    </option>
                                            ...
                                            <div class="form-group {{ $errors->has('history') ? 'has-error' : '' }}">
                                                ...
                                                <div>
                                                    <textarea id="text" cols="55" rows="2"
                                                        name="history">{{ $NationalExecutives->history }}</textarea>
                                                </div>
    ...
    <script>
        ...
        Toast.fire({
            icon: 'success',
            title: 'Administrator! You are on Edit National Executives Page'
        })
    </script>
</body>
