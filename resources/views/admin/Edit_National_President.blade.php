...
<body style="padding-top: 1px">
  ...
  <!-- NAVBAR ENDS HERE--->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>UPDATE NATIONAL PRESIDENT</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group" style="margin-bottom: 20px;">
                                    <img src="{{ asset($NationalPresidents->picture) }}" class="img-thumbnail"
                            ...
                            <div class="card card-body bg-transparent">
                                        ...
                                        <div class="col-md-12" style="display:none">
                                            <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="id" id="id" class="form-control"
                                                    value="{{ $NationalPresidents->id }}" readonly>
                                                @if ($errors->has('id'))
                                ...
                                <form method="POST" novalidate
                                    action="{{ url('administrator/Update_National_President')}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('full_name') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="full_name" id="full_name" class="form-control"
                                                    value="{{ $NationalPresidents->full_name }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('compound') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="compound" id="compound" class="form-control"
                                                    value="{{ $NationalPresidents->compound }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('discepline') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="discepline" id="discepline"
                                                    class="form-control" value="{{ $NationalPresidents->discepline }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="text" name="institution" id="institution"
                                                    class="form-control" value="{{ $NationalPresidents->institution }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="date_of_birth" class="form-control"
                                                    id="date_of_birth" value="{{$NationalPresidents->date_of_birth}}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_from" id="year_of_tenure_from"
                                                    class="form-control"
                                                    value="{{ $NationalPresidents->year_of_tenure_from }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_to" id="year_of_tenure_to"
                                                    class="form-control"
                                                    value="{{ $NationalPresidents->year_of_tenure_to }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
                                                <label for="gender">Gender<i style="color: red">[Optional]</i></label>
                                                <select type="text" name="gender" id="gender" class="form-control"
                                                    value="{{ old('gender') }}">
                                                    <option value="{{$NationalPresidents->gender}}">...Select...
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                                ...
                                                <input type="number" name="phone" id="phone" class="form-control"
                                                    value="{{ $NationalPresidents->phone }}">
                                                @if ($errors->has('phone'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('Office') ? 'has-error' : '' }}">
                                                <label for="Office">Office <i style="color: red">[Optional]</i></label>
                                                <select type="text" name="post" id="Office" class="form-control"
                                                    value="{{ old('post') }}">
                                                    <option value="{{ $NationalPresidents->post }}">...Select...
                                                    </option>
                                            ...
                                            <div class="form-group {{ $errors->has('history') ? 'has-error' : '' }}">
                                                ...
                                                <div>
                                                    <textarea id="text" cols="55" rows="2"
                                                        name="history">{{ $NationalPresidents->history }}</textarea>
                                                </div>
    ...
    <script>
        ...
        Toast.fire({
            icon: 'success',
            title: 'Administrator! You are on Edit National President Page'
        })
    </script>
</body>
