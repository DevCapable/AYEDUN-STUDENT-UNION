...
<body style="padding-top: 1px">
   ...
   <!-- NAVBAR ENDS HERE--->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>UPDATE SPORT DIRECTOR</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Update Sports Director</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group" style="margin-bottom: 20px;">
                                         <img src="{{ asset($SportDetails->picture) }}" class="img-thumbnail"
                            ...
                            <div class="card card-body bg-transparent">
                                ...
                                <form method="POST" action="{{ url('administrator/ChangeSportDp') }}"
                                        ...
                                        <div class="col-md-12" style="display:none">
                                            <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                                ...
                                                <input type="text" name="id" id="id" class="form-control"
                                                    value="{{ $SportDetails->id }}" readonly>
                                                @if ($errors->has('id'))
                                ...
                                <form method="POST" novalidate action="{{ url('administrator/Update_Sports') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('id') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="text" name="compound" id="compound" class="form-control"
                                                    value="{{ $SportDetails->compound }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="text" name="discepline" id="discepline"
                                                    class="form-control" value="{{ $SportDetails->discepline }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="text" name="date_of_birth" class="form-control"
                                                    id="date_of_birth" value="{{ $SportDetails->date_of_birth }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_from" id="year_of_tenure_from"
                                                    class="form-control"
                                                    value="{{ $SportDetails->year_of_tenure_from }}">
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <input type="date" name="year_of_tenure_to" id="year_of_tenure_to"
                                                    class="form-control"
                                                    value="{{ $SportDetails->year_of_tenure_to }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="gender" id="gender" class="form-control"
                                                    value="{{ old('gender') }}">
                                                    <option value="{{ $SportDetails->gender }}">...Select...</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('sports') ? 'has-error' : '' }}">
                                                ...
                                                <select type="text" name="sport" id="sport" class="form-control"
                                                    value="{{ old('sport') }}">
                                                    <option value="{{ $SportDetails->sports }}">...Select...</option>
                                                ...
                                                @if ($errors->has('sports'))
                                                    <span
                                                        class="font-weight-bold">{{ $errors->first('sports') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('history') ? 'has-error' : '' }}">
                                                ...
                                                <div>
                                                    <textarea id="text" cols="30" rows="4"
                                                        name="history">{{ $SportDetails->history }}</textarea>
                                                </div>
    ...
    <script>
        ...
        Toast.fire({
            icon: 'success',
            title: 'Administrator! You are on Edit Sport Page'
        })
