    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12" style="padding-top: 20px;">
                <div class="card">
                    <div class="card-body">
                        <form method="Post"  action="{{ url('user/searchSportDirector') }}" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="StudentSearchViewModel_Search"><strong>Search Sport Director</strong></label>
            ...
            <div class="col-lg-12 col-md-12" style="padding-top: 20px;">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title pull-left text-uppercase text-info font-weight-bolder">Sport Directors' List</h3>
                    ...
                    <div class="card-body" style="">
                        <div class="row el-element-overlay">
                            @foreach ($sportDetails as $sportDetail)<br />
                            <div class="col-lg-3 col-md-3 col-sm-6" style="padding-top: 20px">
                                <div class="card bg-white card-hover" >
                                    <div class="card-header">
                                        
                                        <span class="badge badge-success pull-right">{{ $sportDetail->gender }}</span>
                                        <br>
                                        <span class="badge badge-success pull-left">From ({{ $sportDetail->year_of_tenure_from }}) To ({{ $sportDetail->year_of_tenure_to }})</span>
                                    </div>
                                    <div class="card-body" style="height: 100%; width: 100%">
                                        <div class="card-title text-center">
                                            <img src="{{ asset($sportDetail->picture)}}" class="img_thumbnails" width="200px"
                                                height="200px" class="img-thumbnail"  style="box-shadow: 0px 2px 7px 2px gray ;"
                                                alt="Ayedun Students' Union"/><br />
                                            {{ strtoupper($sportDetail->full_name) }}
                                        </div>
                                        <br />
                                    </div>
                                    <div class="card-footer">
                                        <a title="Click to comment" href="{{ url('sportDetail/like/'.$sportDetail->id) }}"
                                            class="btn btn-outline-info btn-sm pull-left">
                                            <i class="fa fa-comments"></i>
                                        </a>
                                        <a href="{{ url('user/ViewSPortsProfile/'.$sportDetail->id) }}"
                                            class="btn btn-outline-primary btn-sm pull-right">
                                            <i class="fa fa-eye"></i> PROFILE
                                        </a>
                                        <span class="badge badge-success pull-right">{{ $sportDetail->compound }}</span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
