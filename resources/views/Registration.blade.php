            ...
            <div class="col-md-12 offset-col-md-4">
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong style="color: red">Note! <i>This Reg. Page is Strictly For Students only</i></strong>
                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group {{ $errors->has('fullname') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="fullname" id="fullname" class="form-control"
                                            value="{{ old('fullname') }}" placeholder="Please Enter Your Full Name">
                                    ...
                                    <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                        ...
                                        <input type="email" name="email" class="form-control" id="email"
                                            value="{{ old('email') }}" placeholder="Please Enter Your Active Email">
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="form-group {{ $errors->has('username') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="username" id="username" class="form-control"
                                            value="{{ old('username') }}" placeholder="Please Enter Your Username">
                                    ...
                                    <div class="form-group {{ $errors->has('place_of_residence') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="place_of_residence" id="place_of_residence"
                                            ...
                                            placeholder="Please Enter Your Place Of Residence">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group {{ $errors->has('answers') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="answers" id="answers" class="form-control"
                                            value="{{ old('answers') }}"
                                            placeholder="Please Enter What You Can easily Remember">
                                    ...
                                    <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                        ...
                                        <input type="number" name="phone" id="phone" class="form-control"
                                            value="{{ old('phone') }}" placeholder="Please Enter Your Active Phone">
                                        @if ($errors->has('phone'))
