        ...
        <div class="container">
            ...
            <div>
                <marquee behavior="scrolling" direction="left" style="background-color: red; color: white; font-weight: bolder">MISS ASU Application is currently on, kindly sign into your account to apply</marquee>
            </div>
            ...
            <a style="text-decoration: none; font-size: 15px" href="{{ url('/historyOfAyedun') }}" class="btn btn-outline-success"> <i class="fa fa-home"></i> What You Need To Know About Ayedun</a>
            <a href="{{url('/vote')}}"><button class="btn btn-outline-success" >
                <i class="fa fa-info"></i> Cast your vote here!
            </button></a>
            </div>
