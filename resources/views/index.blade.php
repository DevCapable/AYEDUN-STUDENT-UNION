...
<body>
    ...
    <div class="container">
        ...
        <section class="row" id="tm-section-1">
            <div class="col-lg-12 tm-slider-col">
                <div class="tm-img-slider">
                    ...
                    <div class="tm-img-slider-item" href="img/land2.jpeg">
                        <p class="tm-slider-caption">  “ASU executives and the dignitaries/prominents Obas in attendance of the paramount ruller of Ayendun (Obajisun) @80th birthday that came up on 16th of may 2021.</p>
                        <img src="img/land2.jpeg" alt="Image" class="tm-slider-img">
                    </div>
                    <div class="tm-img-slider-item" href="img/land1.jpeg">
                        <p class="tm-slider-caption">  “Arrival of Ayedun Students' Union Executives at the Palace.</p>
                        <img src="img/land1.jpeg" alt="Image" class="tm-slider-img">
                    </div>
                    <div class="tm-img-slider-item" href="img/AyedunCover.jpg">
                        <p class="tm-slider-caption"> 1. “The cure for boredom is curiosity. There is no cure for
                    ...
                    <div class="tm-img-slider-item" href="img/AYEDUN.jpg">
                        <p class="tm-slider-caption"> 2. “The beautiful thing about learning is that no one can take it
                    ...
                    <div class="tm-img-slider-item" href="img/gallery-img-04.jpg">
                        <p class="tm-slider-caption"> 3. “When you educate one person you can change a life, when you
       ...
       <a style="text-decoration: none" href="{{ url('/historyOfAyedun') }}" class="btn btn-outline-success">Know About Ayedun</a>
        <div class="row">
            <section class="tm-section-2 tm-section-mb" id="tm-section-2">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12" style="background-color: #000000; color: #ffffff">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12" style="  box-shadow: 0px 2px 15px 2px gray;">
                    ...
                    <div class="card bg-white card-hover">
                        ...
                        <div class="card-footer">
                            ...
                            <span class="badge badge-success pull-right">EBIOHUN </span>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12" style="  box-shadow: 0px 2px 15px 2px gray;">
                    ...
                    <div class="card bg-white card-hover" style=" float: right;">
                        <div class="card-header">
                            <span style="float: left" class="badge badge-info pull-right">SINCE?
                            </span>
                            <span class="badge badge-success pull-right"></span>
                        ...
                        <div class="card-body">
                            <div class="card-title text-center">
                                <h5><strong>Mrs EBUN M. TIAMIYU</strong></h5>
                            </div>
                        </div>
                        <div class="card-footer">
                            <span class="badge badge-info pull-left">
                ...
                <div class="col-lg-5 col-md-5 col-xs-12 tm-contact-right" style="background-color:rgb(41, 231, 183);">
                    <div class="tm-address-box" style="color: #000; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
                        ...
                        <address>
                            ...
                            <br><i style="font-size: 15px;" class="fa fa-envelope"> <strong> Web Mail:</strong> &nbsp;&nbsp;contactus@ayedunstudentsunion.com 
                              </i>
                            <br> <i style="font-size: 15px;" class="fa fa-envelope"> <strong>Gmail:</strong> &nbsp;&nbsp;ayedunstudentunion4web@gmail.com 
                               </i><br>

                            <strong> Phones: </strong>
                            <br><i style="font-size: 15px;" class="fa fa-phone"> +234 814 368 6809 &nbsp;&nbsp;
                                National
                                PRO</i>,
                            <br> <i style="font-size: 15px;" class="fa fa-phone"> +234 813 452 2741 &nbsp;&nbsp;
    ...
    <footer class="mt-5" style="background-color: #66ff66; color: black; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif ">
        <p class="text-center">Copyright © {!! date('Y') !!} Ayedun Students' Union All Rights Reserved - Powered:
