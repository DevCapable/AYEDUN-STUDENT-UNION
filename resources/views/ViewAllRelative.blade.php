                ...
                <div class="card">
                    ...
                    <div class="card-body" style="overflow-x:auto;">
                        <div class="row el-element-overlay">
                            @foreach ($relatives as $Relative)<br />
                            <div class="col-lg-3 col-md-3 col-sm-6" style="padding-top: 20px">
                                <div class="card bg-white card-hover" >
                                    <div class="card-header">
                                        ...
                                        <span class="badge badge-success pull-right">{{ $Relative->gender }}</span>
                                    </div>
                                    <div class="card-body" style="height: 100%; width: 100%">
                                        <div class="card-title text-center">
                                            <img src="{{ asset($Relative->picture)}}" class="img_thumbnails" width="200px"
                                                height="200px" class="img-thumbnail" alt="Ayedun Students' Union"/><br />
                                            {{ strtoupper($Relative->fullname) }}
                                        </div>
                                        <br />
                                    </div>
                                    <div class="card-footer">
                                        <a title="Click to comment" href="{{ url('Relative/like/'.$Relative->id) }}"
                                            class="btn btn-outline-info btn-sm pull-left">
                                            <i class="fa fa-comments"></i>
                                        </a>
                                        <a href="{{ url('user/ViewAllRelative/'.$Relative->id) }}"
                                            class="btn btn-outline-primary btn-sm pull-right">
                                            <i class="fa fa-eye"></i> PROFILE
                                        </a>
                                        <span class="badge badge-success pull-right">{{ $Relative->compound }}</span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
