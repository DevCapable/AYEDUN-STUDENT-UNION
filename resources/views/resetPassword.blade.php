    ...
    <div class="login-box">
        ...
        <div class="card">
            ...
            <p class="mb-0">
                ...
                <strong style=" color: red"> <i>Do No Worry! If peradventure you seemed not remember required information to reset your password!, just get contact with Administrator, You can message through HomePage Query Box or call numbers beside Thanks.</i></strong>
            </p><br>
