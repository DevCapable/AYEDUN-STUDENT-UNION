...
<div class="login-box">
  ...
  <div class="card">
    ...
    <div class="card-header">
        <h4 class="card-title"><a href="https://www.ayedunstudentsunion.com/"><img style="border-radius: 100px; " src="img/ASU_LOGO.png" height="50" width="60"
            class="img-responsive" alt="ASU logo" class="img-rounded"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>LOG IN</strong></h4>
