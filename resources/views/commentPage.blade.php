                ...
                <div class="card">
                        ...
                        <div class="card-header">
                            <p
                                ...
                                @elseif ($checkPost->posting =='' && $checkPost->video=='')
                                    <img src="{{ asset($checkPost->image) }}" class="img-thumbnail"
                                        width="60%" height="70%" />
                    ...
                    @foreach ($comments as $item)
                        ...
                        <table class="table" style="">
                            ...
                            <tr>
                                ...
                                <td style=" width: 50% ">
                                   <i style="border-color: grey; border-style: solid; border-radius: 100px; padding: 10px"> {{ $item->comment }}</i>
                                </td>
                                ...
                                <td style="float: right" colspan="4">
                                    ...
                                    <a title="Click to View Delete" href="{{ url('user/deleteCommentToPost/' . $item->id) }}"
                                        class="btn btn-outline-danger btn-sm pull-right">
                                        <i class="fa fa-trash"></i>
                                    </a>
                                    <a title="Click to View Edit" href="{{ url('user/editCommentToPost/' . $item->id) }}"
                                        class="btn btn-outline-info btn-sm pull-right">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a title="Click to View Profile" href="{{ url('user/view_user_profile/' . $item->id) }}"
                    ...
                    <form method="POST" action="{{ url('user/commentPage') }}" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <input  class="form-control" type="text" name="username" value="{{ $verifyUser->username }}">
