        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <form method="POST" action="{{ url('user/logout') }}" id="logout" novalidate>
                    ...
                    Back</a><a href="{{ url('user/onlineUsers') }}" class="btn btn-info">Online Users</a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td style="float: right">
                                    <span style="float: left"
                                        class="badge badge-info pull-right">{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}
                                    </span>
                                </td>
                                <td style="float: right">

                                    <a title="Click to View Delete"
                                        href="{{ url('user/deleteMyMessage/' . $item->id) }}"
