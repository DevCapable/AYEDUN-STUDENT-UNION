...
<footer style="background-color: #ccffe6;">
    <div class="container" >
        <div class="row">
            <div class="col-md-4">
                <strong>Copyright &copy; {{ now()->year }} <a href="https://www.ayedunstudentsunion.com">Ayedun Student's Union</a>. <br></strong>
                All rights reserved.
            ...
            <div class="col-md-4">
                <strong>Designed by: CapeTech Inc  <a href="https://web.facebook.com/abdulrasaqolawale.olabode/about_details"></a>. <br></strong>
