                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group {{ $errors->has('stakeholder') ? 'has-error' : '' }}">
                                        <input type="text" name="guest" id="stakeholder" class="form-control" value="{{"
                                            GUEST" }}" readonly>
                                    ...
                                    <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                        ...
                                        <input type="email" name="email" class="form-control" id="email"
                                            value="{{ old('email') }}" placeholder="Enter Your Address">
                                        @if ($errors->has('email'))
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                                        ...
                                        <span class="font-weight-bold">{{ $errors->first('address') }}</span>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group {{ $errors->has('answers') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="answers" id="answers" class="form-control"
                                            value="{{ old('answers') }}" placeholder="Enter Your Current Address">
